...
ggplot(Kansas.DO, aes(x = DateTime_Solar, y = Discharge_m3s)) + geom_line()

ggplot(Kansas.DO, aes(x = DateTime_Solar, y = DO_mgL)) + geom_line()

ggplot(Kansas.DO, aes(x = DateTime_Solar, y = Nitrate_mgL)) + geom_line()
