...
> The 30yr model underestimated the amount of discharge for high recurrance interval event
...
> use past years - most recent. but stationarity is dead anyways. 
...
SaladoRecurrencePlot.Full <- 
  ggplot(SaladoRecurrence.first, aes(x = RecurrenceInterval, y = PeakDischarge)) +
  geom_point() +
  geom_point(data = SaladoRecurrence.last, color = "#02818a",
             aes(x = RecurrenceInterval, y = PeakDischarge))
print(SaladoRecurrencePlot.Full)

#running both models
Salado.RImodel.first <- lm(data = SaladoRecurrence.first, PeakDischarge ~ log(RecurrenceInterval))
summary(Salado.RImodel.first)

Salado.RImodel.last <- lm(data = SaladoRecurrence.last, PeakDischarge ~ log(RecurrenceInterval))
summary(Salado.RImodel.last)

#Getting coefficients
Salado.RImodel.first$coefficients #-273, 1489
Salado.RImodel.last$coefficients #-1005, 3412

#100 year interval
Salado.RImodel.first$coefficients[1] + Salado.RImodel.first$coefficients[2]*log(100)

Salado.RImodel.last$coefficients[1] + Salado.RImodel.last$coefficients[2]*log(100)

#500 year interval
Salado.RImodel.first$coefficients[1] + Salado.RImodel.first$coefficients[2]*log(500)

Salado.RImodel.last$coefficients[1] + Salado.RImodel.last$coefficients[2]*log(500)
