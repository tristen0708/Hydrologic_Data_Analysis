...
> No! Because the data is seasonal/cyclical so highs and lows cancel
...
> Regular time scale to get rid of seasonality
> Don't use seasonal data
> Decompose into annual means
