...
-Good use of colors (accessible color palette)
-Expected use of color gradients
-Label everything (axis, units) *
-Legible font sizes *
-Legible data point sizes (large or small enough) *
-Scale of axises
-Having a legend *
-Appropriate graph type *
-Interactive data (if it's digital)
...
<I would ask someone not working on my project to identify which graph is the easiest to understand> 

<Density plots are good - ridgeline is many density>
<Boxplots can be misleading with varying sample sizes>
