...
## What to know the unique values , not mean, etc
...
Here we are highlighting depths considered the **epilimnion - surface** and **hypolimnion - bottom**.
```{r}
Tempplot.mixed <- 
...
#Four degrees celcius is the densest water gets before it expands to become ice... so it's
 # the coldest the water will be in a lake
...
Wind and density. Need a small density gradient for mixing to happen otherwise wind can't overcome it
