...
Means, median, range; Reduce rows into more useful set to do time series

> subsampling: 

let's say one year we sample every week, one year we sample bi-weekly ;
don't want to aggregate... will do by loking at two week

> interpolation: 

fill in missing data to have even time series
...
* **Piecewise constant**: take the nearest point and use that estimate "nearest neighbor"
* **Linear**: straight line between points
* **Spline**:connects with a curvy line - doesn't necessarily work better than linear for aquatic sciences though
...
# Inspect results
Mendotatrend 
#Z score gives us direction and magnitude of our trend
#p-value tells us if trend is significant
#S - the larger in magnitude, the greater the trend
...
> Overall, there is no significant change in total phosphorus concentrations from 1988 to 2013; however, for the months of October and November specifically, there is a significant decrease in total phosphorus concentrations over our time series. 
...
#We WANT stationary data- so we WANT to reject the null hypothesis and have a low p-value
