...
> When the values are below the line it means the variable on the x-axis is influencing the conditions in the lake more
...
> Violin: Range, Median, distribution of data, how much of that data lies where 
